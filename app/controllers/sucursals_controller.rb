class SucursalsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @sucursal.save
        format.html { redirect_to @sucursal, notice: 'Sucursal se guardo con exito.' }
  ...
  def update
    respond_to do |format|
      if @sucursal.update(sucursal_params)
        format.html { redirect_to @sucursal, notice: 'Sucursal se actualizo con exito.' }
  ...
  def destroy
    @sucursal.destroy
    respond_to do |format|
      format.html { redirect_to sucursals_url, notice: 'Sucursal se elimino con exito.' }
  ...
  private
    ...
    def sucursal_params
      params.require(:sucursal).permit(:nombre, :direccion, :localidad, :telefono, :email)
    end
end
